...
public class ManufacturerEntity implements MyEntity{
	...
	private List<ContactPersonEntity> contactPerson;
	...
	public void setContactPersons(List<ContactPersonEntity> contactPerson) {
		this.contactPerson = contactPerson;
	}
	
	public void add(ContactPersonEntity contactPersonEntity) {
		contactPersonEntity.setManufacturer(this);
		getContactPersons().add(contactPersonEntity);
	}

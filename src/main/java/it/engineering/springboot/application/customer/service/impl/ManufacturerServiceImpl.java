...
import it.engineering.springboot.application.customer.mapper.ManufacturerMapper;
...
public class ManufacturerServiceImpl implements ManufacturerService {
	...
	public ManufacturerDto save(ManufacturerDto manufacturerDto) throws MyEntityNotPresentedException {
		...
		if(!cityEntity.isPresent()) {
			throw new MyEntityNotPresentedException("City with code "+ manufacturerDto.getCity().getCityCode()+" does not exist!");
		}
		
		ManufacturerEntity manufacturerEntity =  manufacturerRepository.save(manufacturerMapper.toEntity(manufacturerDto));
